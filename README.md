...
* When the button start is pressed on the Unity Interface, the experiment is launched and participant must look at the TouchDesigner Interface
* Once the mandatory session is over, Unity stop touchDesigner and wait for participant to press spaceBar to start the free session
